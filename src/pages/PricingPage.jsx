...
const FAQS = [
  ...
  { q: 'How does store setup work?', a: 'You can connect an existing Shopify store securely in under five minutes, or create a brand-new native storefront directly on Selora. We only ask for the permissions necessary to manage products and analyze campaigns, and all store data is encrypted securely.' },
