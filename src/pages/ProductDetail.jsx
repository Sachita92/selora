...
const s = {
  page: { minHeight: '100vh', padding: '2.5rem 2rem 5rem', background: 'radial-gradient(circle at top right, rgba(95, 141, 118, 0.04), transparent 45%), radial-gradient(circle at bottom left, rgba(95, 141, 118, 0.02), transparent 45%), var(--bg-0)', fontFamily: 'var(--font-body)' },
  backBtn: { display: 'inline-flex', alignItems: 'center', gap: '.4rem', background: 'none', border: `1px solid ${c.border}`, borderRadius: 8, padding: '.55rem 1rem', fontSize: '.8rem', color: c.muted, cursor: 'pointer', fontFamily: 'var(--font-body)', textDecoration: 'none', transition: 'all 0.2s', marginBottom: '2rem' },
  ...
  title: { fontFamily: 'var(--font-display)', fontSize: '2rem', fontWeight: 400, color: c.dark, margin: '1rem 0 .5rem', lineHeight: 1.2 },
  ...
  btnP: { background: c.green, color: '#fff', border: 'none', padding: '.7rem 1.4rem', borderRadius: 8, fontSize: '.82rem', fontWeight: 600, cursor: 'pointer', fontFamily: 'var(--font-body)', textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '.4rem', flex: 1 },
}
    ...
    return (
      <div style={s.page}>
        ...
        <div style={{ textAlign: 'center', padding: '4rem 0', color: c.muted }}>
          <h2 style={{ fontFamily: 'var(--font-display)', color: c.dark, marginBottom: '.5rem' }}>Product Not Found</h2>
